from app.schema.help_schema import HelpItem, HelpResponse
    ...
    def get_help(self) -> HelpResponse:
        help_items = [
            ...
            HelpItem(
                name="Регистрация",
                description=[
                    "После регистрации видеоролики автоматически сохраняются в \
«Историю запросов» для быстрого доступа к загруженным роликам.",
